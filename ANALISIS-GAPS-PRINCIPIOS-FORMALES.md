...
### Operabilidad (0)
*(Todos eran prácticas - ya movidos a lineamientos)*
...
3. 🟡 **Data Governance** - Cuando se clarifiquen requerimientos de compliance
4. 🟡 **Privacy by Design** - Cuando se defina alcance de datos sensibles
