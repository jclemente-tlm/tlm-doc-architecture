...
| **Versionado (módulos)**     | ✅ Registry + semver                            | ✅ Registry + versioning                    | ✅ Git tags + Galaxy                 | ✅ CloudFormation registry    | ✅ Template Specs versioning   |
...
- Portabilidad multi-cloud mediante módulos reutilizables
...
- **Complejidad gestión de estado:** mitigado con S3 + DynamoDB locking y documentación de mejores prácticas
- **Curva de aprendizaje HCL:** mitigado con capacitación del equipo y plantillas corporativas
- **Drift en infraestructura manual:** mitigado con terraform plan automatizado y políticas de solo IaC
