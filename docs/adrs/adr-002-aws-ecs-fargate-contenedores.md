...
| **Madurez**                    | ✅ Alta (2017, pionero serverless)          | ✅ Muy alta (2018, AWS-managed)                     | ✅ Muy alta (2018, Azure-managed)       | ⚠️ Media (2017, nicho)              | ⚠️ Baja (2014, legacy)               |
...
| **Complejidad operativa**      | ✅ Baja (0.25 FTE, `<5h/sem)`               | ⚠️ Alta (1 FTE, 10-20h/sem)                          | ⚠️ Alta (1 FTE, 10-20h/sem)               | ✅ Baja (0.25 FTE, `<5h/sem)`       | ⚠️ Alta (1 FTE, 10-20h/sem)          |
| **Multi-tenancy**              | ✅ Aislamiento por task                     | ✅ Namespaces + RBAC                                | ✅ Namespaces + RBAC                    | ✅ Container groups                 | ⚠️ Configuración manual                     |
...
| **Estrategias de despliegue**  | ✅ Rolling, Blue/Green, Canary              | ✅ Rolling, Blue/Green, Canary                      | ✅ Rolling, Blue/Green, Canary          | ⚠️ Rolling update básico             | ⚠️ Implementación manual             |
| **Service Mesh**               | ⚠️ App Mesh integration (manual)            | ✅ Istio, Linkerd nativos                           | ✅ Open Service Mesh                    | ❌ No soportado                     | ⚠️ Configuración manual Envoy/Linkerd       |
...
- **Costos serverless premium:** mitigado con monitoreo, dimensionamiento adecuado y Savings Plans
- **Límites por cuenta:** mitigado con planificación de cuotas y multi-account strategy
