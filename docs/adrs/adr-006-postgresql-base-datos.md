...
| **Adopción**                | ✅ Muy alta (DB del año, líder OSS)             | ✅ Muy alta (estándar web)                   | ✅ Muy alta (Microsoft legacy)         | ✅ Muy alta (enterprise líder)           | ✅ Alta (MySQL/PG compatible)        |
...
| **Alta disponibilidad**     | ✅ 99.9% estimado (replicación master-slave)    | ✅ 99.9% estimado (Group Replication)            | ✅ 99.99% SLA (Always On clustering)   | ✅ 99.99% SLA (RAC clustering)           | ✅ 99.99% SLA Multi-AZ               |
| **Extensibilidad**          | ✅ Plugins, JSONB, PostGIS                      | ⚠️ Limitada                                  | ⚠️ Limitada                            | ✅ Máxima                                | ⚠️ Limitada                          |
| **Portabilidad**            | ✅ Multi-plataforma                             | ✅ Multi-plataforma                          | ⚠️ Windows y Linux (desde 2017)          | ❌ Limitada                              | ❌ AWS                               |
