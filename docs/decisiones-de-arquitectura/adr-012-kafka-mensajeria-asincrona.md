...
| **Adopción**              | ✅ Muy alta (28K⭐, líder mercado)                 | ✅ Alta (GCP native adoption)                    | ✅ Muy alta (AWS standard)                    | ✅ Muy alta (12K⭐, RabbitMQ)             | ✅ Alta (Azure ecosystem)                     |
| **Modelo de gestión**     | ⚠️ Self-hosted                                     | ✅ Gestionado (GCP)                              | ✅ Gestionado (AWS)                           | ⚠️ Self-hosted                            | ✅ Gestionado (Azure)                         |
| **Complejidad operativa** | ⚠️ Alta (1 FTE, 10-20h/sem)                        | ⚠️ Alta (1 FTE, 10-20h/sem)                      | ✅ Baja (0.25 FTE, <5h/sem)                   | ⚠️ Alta (1 FTE, 10-20h/sem)               | ⚠️ Media (0.5 FTE, 5-10h/sem)                 |
| **Integración .NET**      | ✅ Confluent.Kafka (5M+ DL/mes, .NET 6+, async)    | ✅ Google.Cloud.PubSub (3M+ DL/mes, .NET 6+)     | ✅ AWSSDK.SQS + SNS (10M+ DL/mes cada uno)    | ✅ RabbitMQ.Client (20M+ DL/mes, .NET 6+) | ✅ Azure.Messaging.ServiceBus (5M+ DL/mes)    |
...
| **Costos**                | ⚠️ $0 licencia + ~$300-800/mes infra               | ❌ $40/TB ingress + $0.12/GB egress (~$500+/mes) | ✅ $0.50/millón msg + $0.09/GB (~$50-150/mes) | ✅ $0 licencia + ~$150-300/mes infra      | ⚠️ $0.05/millón ops + storage (~$100-300/mes) |
