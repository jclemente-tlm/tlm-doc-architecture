...
| **Storage Classes**       | ✅ Standard, IA, Glacier, Deep Archive               | ⚠️ Solo Standard                             | ✅ Hot, Cool, Archive tiers                    | ✅ Standard, Nearline, Coldline, Archive      | ⚠️ Solo Standard                       |
| **Lifecycle Policies**    | ✅ Transitions + Expiration automáticas              | ❌ No soportado                              | ✅ Políticas completas                         | ✅ Políticas completas                        | ⚠️ Básico (expiration)                 |
| **Replication**           | ✅ Cross-region + Same-region async                  | ❌ No soportado                              | ✅ Geo-replication                             | ✅ Multi-region replication                   | ⚠️ Manual (rsync/rclone)               |
