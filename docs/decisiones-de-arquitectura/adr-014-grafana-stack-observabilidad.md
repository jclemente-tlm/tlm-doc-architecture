...
| **Integración .NET**                 | ✅ `OpenTelemetry.*` (5M+ DL/mes, .NET 6+)     | ✅ `Serilog.Sinks.Elasticsearch` (5M+ DL/mes) | ✅ `Datadog.Trace` (1M+ DL/mes, APM completo) | ✅ `Splunk.Logging.*` (500K+ DL/mes)      | ✅ `AWSSDK.CloudWatch` (10M+ DL/mes)    |
