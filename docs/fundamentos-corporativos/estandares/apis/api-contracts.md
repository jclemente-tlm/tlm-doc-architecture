...
- **Consistencia**: cuando la validación falla, `ApiExceptionHandler` produce automáticamente `errors[].details` por campo
...
Preferir **FluentValidation** para lógica de validación compleja, condicional o reutilizable. Data Annotations es adecuado para contratos simples. Ambos son interceptados por `ApiExceptionHandler` automáticamente.
:::
