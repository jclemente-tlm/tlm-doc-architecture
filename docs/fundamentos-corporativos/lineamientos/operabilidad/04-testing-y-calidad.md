...
**No aplica a:** Monitoreo y alertas en producción, gestión de incidentes operativos (ver [Observabilidad](../arquitectura/05-observabilidad.md)).

## Prácticas Recomendadas

- [Implementar pruebas automatizadas en múltiples niveles (unitarias, integración, e2e)](../../estandares/operabilidad/piramide-testing.md)
...
- [Realizar code review obligatorio antes de merge a ramas principales](../../estandares/operabilidad/code-review.md)
