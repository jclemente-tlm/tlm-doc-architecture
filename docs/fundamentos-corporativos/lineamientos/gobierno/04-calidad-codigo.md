...
**No aplica a:** Testing automatizado (ver [Estrategia de Pruebas](../desarrollo/02-testing.md)), monitoreo en producción.
...
- [Realizar code review obligatorio antes de merge a ramas principales](../../estandares/desarrollo/code-quality-review.md)

## Referencias Relacionadas

- [Estrategia de Pruebas](../desarrollo/02-testing.md) (testing automatizado)
