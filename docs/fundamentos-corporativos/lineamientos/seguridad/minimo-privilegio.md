...
- [Implementar Just-In-Time (JIT) access](../../estandares/seguridad/iam-advanced.md)
- [Realizar access reviews periódicos](../../estandares/seguridad/iam-advanced.md)
- [Aplicar segregation of duties](../../estandares/seguridad/security-governance.md)
- [Usar service accounts con permisos mínimos](../../estandares/seguridad/iam-advanced.md)
