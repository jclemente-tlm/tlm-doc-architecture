...
- [Testear dominio de forma aislada sin dependencias de infraestructura](../../estandares/testing/unit-testing.md)
- [Implementar patrón Repositorio como port para abstraer persistencia](../../estandares/arquitectura/clean-architecture.md#1-hexagonal-architecture-ports-adapters)
