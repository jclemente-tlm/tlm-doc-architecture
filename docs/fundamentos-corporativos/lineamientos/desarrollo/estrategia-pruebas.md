...
> **Nota:** Para monitoreo, alertas y observabilidad ver [Observabilidad](../arquitectura/observabilidad.md).
...
- [Observabilidad](../arquitectura/observabilidad.md) (monitoreo y alertas en producción)
